...
local PROGBAR_LUA_URL = "https://raw.githubusercontent.com/mrjoe3012/ocproj/master/gui/ProgressBar.lua?flush_cache=True"
local PROGBAR_INSTALL_DIR = "/lib/ProgressBar.lua"
...
exec(string.format("wget -f %s %s", PROGBAR_LUA_URL, PROGBAR_INSTALL_DIR))
print("gui installed.")